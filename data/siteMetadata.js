...
const siteMetadata = {
  ...
  description: '专注于跨性别、非二元性别、变装、CDTS、伪娘、男娘、性转等多元性别表达内容的垂直搜索与索引平台',
  language: 'zh',
  theme: 'system', // system, dark or light
  siteUrl: 'https://tsindex.org',
  siteRepo: 'https://github.com/weekendfish/search_engine',
  siteLogo: `${process.env.BASE_PATH || ''}/static/images/logo.png`,
  socialBanner: `${process.env.BASE_PATH || ''}/static/images/twitter-card.jpg`,
  // mastodon: 'https://mastodon.social/@mastodonuser',
  email: 'admin@tsindex.org',
  ...
  analytics: {
    ...
    // },
    googleAnalytics: {
      googleAnalyticsId: 'G-T5D40G80SK', // e.g. G-XXXXXXX
    },
  },
  newsletter: {
